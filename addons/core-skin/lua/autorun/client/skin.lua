--[[
addons/derma_sobaki/lua/autorun/client/skin.lua
--]]
...
cols.g = cols.g or Color(133,100,67,255)

cols.o = cols.o or Color(170,119,102, 255)


cols.bg = cols.bg or Color(24,24,24, 255)
--cols.bg = cols.bg or Color(85,68,85, 255)
--cols.bg = cols.bg or Color(30,30,30,255)
...
SKIN.bg_color                   = Color(43,43,43,255)
