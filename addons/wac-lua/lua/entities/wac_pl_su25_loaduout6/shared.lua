...
ENT.Seats = {
	{
		...
		weapons = {"ГШ-30-2","КАБ-500","ФАБ-250М-62","Р-60",}
	},
}
...
function ENT:DrawPilotHud()
	...
	if self:GetNWInt("seat_1_actwep") == 2 and self.weapons["КАБ-500"] then
		surface.SetTextPos(170,450)
