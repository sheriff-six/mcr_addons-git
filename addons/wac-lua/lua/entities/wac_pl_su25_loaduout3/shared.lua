...
ENT.WeaponAttachments = {
	b13_1 = {
		...
		pos = Vector(-15, -108.4,58),
		restrictPitch = true,
		restrictYaw = true,
	},
	fuel_tank_1 = {
		model = "models/sw/avia/bombs/fuel_tank2.mdl",
		pos = Vector(-31, -77.5, 65.5),
		restrictPitch = true,
		restrictYaw = true,
	},
	b13_2 = {
...
function ENT:DrawPilotHud()
	...
	if self:GetNWInt("seat_1_actwep") == 2 and self.weapons["С-13"] then
		surface.SetTextPos(170,450)
		local n = self.weapons["С-13"]:GetAmmo()
		surface.DrawText("Оружие:С-13" .. getspaces(n))
	end
