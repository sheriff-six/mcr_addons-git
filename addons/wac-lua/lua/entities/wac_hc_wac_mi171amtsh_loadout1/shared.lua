...
ENT.PrintName		= "MI-8AMTSH Loadout1"
...
ENT.WeaponAttachments = {
	b8v20_2 = {
		...
		pos = Vector(38,107,35),
		restrictPitch = true,
		restrictYaw = true,
	},
	b8v20_1 = {
		model = "models/sw/avia/bombs/b8v20.mdl",
		pos = Vector(38,-108,35),
		restrictPitch = true,
		restrictYaw = true,
	},
	b8v20_3 = {
		model = "models/sw/avia/bombs/b8v20.mdl",
		pos = Vector(38,-141,35),
		restrictPitch = true,
		restrictYaw = true,
	},
	b8v20_4 = {
		model = "models/sw/avia/bombs/b8v20.mdl",
		pos = Vector(38,139,35),
		restrictPitch = true,
		restrictYaw = true,
	},
}
...
function ENT:DrawPilotHud()
	...
	if self:GetNWInt("seat_2_actwep") == 1 and self.weapons["С-8 №1"] then
		surface.SetTextPos(400,300)
		local n = self.weapons["С-8 №1"]:GetAmmo()
		surface.DrawText("С-8 №1" .. getspaces(n))
	end
	if self:GetNWInt("seat_1_actwep") == 1 and self.weapons["С-8 №1"] then
		surface.SetTextPos(150,420)
		local n = self.weapons["С-8 №1"]:GetAmmo()
		surface.DrawText("Оружие:С-8 №1" .. getspaces(n))
	end
	if self:GetNWInt("seat_2_actwep") == 1 and self.weapons["С-8 №2"] then
		surface.SetTextPos(400,320)
		local n = self.weapons["С-8 №2"]:GetAmmo()
		surface.DrawText("С-8 №2" .. getspaces(n))
	end
	if self:GetNWInt("seat_1_actwep") == 2 and self.weapons["С-8 №2"] then
		surface.SetTextPos(150,420)
		local n = self.weapons["С-8 №2"]:GetAmmo()
		surface.DrawText("Оружие:С-8 №2" .. getspaces(n))
	end
