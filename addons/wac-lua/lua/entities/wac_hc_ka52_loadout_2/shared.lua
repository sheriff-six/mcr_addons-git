...
ENT.WeaponAttachments = {
	...
	S13_launcher = {
		...
		pos = Vector(-3,-76.3,-24),
		restrictPitch = true,
		restrictYaw = true,
	},
	S13_launcher_2 = {
		model = "models/sw/avia/bombs/b13.mdl",
		pos = Vector(-3,78.6,-24),
		restrictPitch = true,
		restrictYaw = true,
	},
	vyihr_launcher_1 = {
...
function ENT:DrawPilotHud()
	...
	if self:GetNWInt("seat_2_actwep") == 1 and self.weapons["С-13"] then
		surface.SetTextPos(20,320)
		local n = self.weapons["С-13"]:GetAmmo()
		surface.DrawText("С-13" .. getspaces(n))
	end
