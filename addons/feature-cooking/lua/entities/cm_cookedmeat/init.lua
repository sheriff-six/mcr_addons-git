...
function ENT:Initialize()
	self:SetModel( "models/foodnhouseholditems/steak2.mdl" )
...
function ENT:Think()
	if self.bad == true then
	    ...
	    bread:Spawn()
		bread:SetModel("models/foodnhouseholditems/steak2.mdl")
	end
end

hook.Add("PlayerDeath", "meat_timers", function(victim, inflictor, attacker)
