...
function ENT:Initialize()
	self:SetModel( "models/foodnhouseholditems/mcdburger.mdl" )
...
function ENT:Use( activator )
	if self.poison == false then
		activator:SetHealth( math.min( activator:GetMaxHealth(), activator:Health() + 80 ) )
...
hook.Add("PlayerDeath", "burger2_timers", function(victim, inflictor, attacker)
