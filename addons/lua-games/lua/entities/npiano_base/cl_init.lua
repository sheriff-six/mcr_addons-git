...
function ENT:AltMod() end // Called when they press alt
...
hook.Add( "HUDPaint", "InstrumentPaint", function()
	...
	if IsValid( LocalPlayer().Instrument ) then
		...
		draw.SimpleText( "PRESS TAB TO LEAVE THE PLAYABLE PIANO AND ALT TO TOGGLE MICROPHONE", "InstrumentNotice", ScrW() / 2, ScrH() - 35, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1 )
...
net.Receive( "NPianoNetwork", function( length, client )
