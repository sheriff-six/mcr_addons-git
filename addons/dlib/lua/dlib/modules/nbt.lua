  ...
  local _base_0 = {
    ...
    AddTypedValue = function(self, key, value)
      ...
      elseif 'table' == _exp_0 then
        return self:AddTagCompound(key, value)
      elseif 'boolean' == _exp_0 then
        return self:AddByte(key, value and 1 or 0)
      elseif 'Angle' == _exp_0 then
        return self:AddTagList(key, TypeID.TAG_Float, {
          value.p,
          value.y,
          value.r
        })
