do
  ...
  http.DLibCookie = _class_0
end
do
  local _class_0
  local _base_0 = {
    Add = function(self, input, domain)
      local cookie = isstring(input) and http.DLibCookie:Parse(input, domain) or input
  ...
  _class_0 = setmetatable({
    __init = function(self, cookiejar)
      ...
      elseif type(cookiejar) == 'table' then
        ...
        self.cookiejar = http.DLibCookieJar()
      end
