...
ply:IsAdmin()
		if not (ply:IsUserGroup("founder") or (ply:IsUserGroup("admin")) or (ply:IsUserGroup("senior_admin")) or (ply:IsUserGroup("senior_game_master"))or (ply:IsUserGroup("deputy_admin")) or (ply:IsUserGroup("game_master")) ) then return end
