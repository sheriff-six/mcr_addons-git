...
list.Set("simfphys_vehicles","gred_simfphys_bmp1_custom",{
	Name = "BMP-1", 
	Model = Model("models/vehicles_shelby/tanks/bmp1/bmp1.mdl"),
	...
	Members = {
		...
		EnginePos = Vector(94,0,61),
		
		CustomWheels = true,
		
		CustomWheelModel = "models/hunter/blocks/cube1x1x1.mdl",
		
		CustomWheelPosFL = Vector(73,60,10),
		CustomWheelPosFR = Vector(73,-60,10),
		
		CustomWheelPosML = Vector(0,60,10),
		CustomWheelPosMR = Vector(0,-60,10),
		
		CustomWheelPosRL = Vector(-75,60,10),
		CustomWheelPosRR = Vector(-75,-60,10),
		CustomWheelAngleOffset = Angle(0,180,0),
		
		CustomMassCenter = Vector(-8.78125,0.0625,45.75),
...
gred.simfphys["gred_simfphys_bmp1_custom"] = {
	Seats = {
		[0] = { -- Driver
			ArcadeMode = {
				...
				Sight = {
					...
					SightFOV = 80,
					SightFOVZoom = 60, -- ammount of FOV to remove, not the actual zoom value
	...
	PostSVInit = function(vehicle)
		...
		for i = -1,1,2 do
			...
			table.insert(float_bmp1,ent)
		end

		vehicle.float_bmp1 = float_bmp1
		...
		vehicle.PhysicsUpdate = function(vehicle,phy)
			...
			for i = 1,2 do
				local ent = vehicle.float_bmp1[i]
		...
		if not FloatingBMP1 then
			FloatingBMP1 = FloatingBMP1 or gred.TankUpdateSuspension

			gred.TankUpdateSuspension = function(vehicle,ct,SusDataTab)
				FloatingBMP1(vehicle,ct,SusDataTab)
...
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[1].NormalMode = table.FullCopy(gred.simfphys["gred_simfphys_bmp1_custom"].Seats[0].ArcadeMode) -- we use table.FullCopy so we can change stuff
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[1].NormalMode.Hatches = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[1].ArcadeMode.Hatches -- we want the seat's normal mode to have the same hatches as in arcade mode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[1].NormalMode.FirstPersonViewPosIsInside = true
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[1].NormalMode.ViewAttachment = nil
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[1].NormalMode.ThirdPersonViewPos = Vector(20,70,80)
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[1].NormalMode.Attachment = "turret_att"

gred.simfphys["gred_simfphys_bmp1_custom"].Seats[2].ArcadeMode = {
	FirstPersonViewPosIsInside = true,
...
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[2].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[2].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[3].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[3].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[4].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[4].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[5].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[5].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[6].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[6].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[7].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[7].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[8].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[8].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[9].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[9].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[10].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[10].ArcadeMode
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[11].NormalMode = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[11].ArcadeMode

gred.simfphys["gred_simfphys_bmp1_custom"].Seats[0].NormalMode.Hatches = gred.simfphys["gred_simfphys_bmp1_custom"].Seats[0].ArcadeMode.Hatches
gred.simfphys["gred_simfphys_bmp1_custom"].Seats[0].NormalMode.ViewPort = {
	FreeView = true,
	--Attachment = "gunner_sight",
	Pos = Vector(55,32,74),
	Ang = Angle(0,0,0),
