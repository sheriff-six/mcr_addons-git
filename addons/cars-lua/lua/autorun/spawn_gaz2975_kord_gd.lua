...
list.Set("simfphys_vehicles","gred_simfphys_gaz2975_kord",{
	Name = "GAZ 2975 (Kord)", 
	Model = Model("models/cars/rus/gaz/gaz2975.mdl"),
...
local Gaz2975_pkp_SusData = {}

local Maxs = Vector(10,10,0)

for i = 1,2 do
	Gaz2975_pkp_SusData[i] = { 
...
gred.simfphys["gred_simfphys_gaz2975_kord"] = {
	Seats = {
		[0] = { -- Driver
			ArcadeMode = {
...
gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[2].NormalMode = gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[2].ArcadeMode
gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[3].NormalMode = gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[3].ArcadeMode
gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[4].NormalMode = gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[4].ArcadeMode
gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[5].NormalMode = gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[5].ArcadeMode

gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[1].ArcadeMode = {
	FirstPersonViewPosIsInside = true,
...
gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[1].NormalMode = gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[1].ArcadeMode

gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[0].NormalMode.Hatches = gred.simfphys["gred_simfphys_gaz2975_kord"].Seats[0].ArcadeMode.Hatches