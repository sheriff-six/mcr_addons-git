...
list.Set("simfphys_vehicles","gred_simfphys_gaz2975_ags",{
	Name = "GAZ 2975 (AGS30)", 
	Model = Model("models/cars/rus/gaz/gaz2975_ags.mdl"),
...
hook.Add("GredAmmoBoxAddShell","30MILIMETERSHELLS",function(SHELLS)
	SHELLS["30"] = {
		["AP"] = false,
		["APBC"] = false,
		["APC"] = false,
...
gred.simfphys["gred_simfphys_gaz2975_ags"] = {
	Seats = {
		[0] = { -- Driver
			ArcadeMode = {
...
gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[2].NormalMode = gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[2].ArcadeMode
gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[3].NormalMode = gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[3].ArcadeMode
gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[4].NormalMode = gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[4].ArcadeMode
gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[5].NormalMode = gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[5].ArcadeMode

gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[1].ArcadeMode = {
	FirstPersonViewPosIsInside = true,
...
gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[1].NormalMode = gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[1].ArcadeMode

gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[0].NormalMode.Hatches = gred.simfphys["gred_simfphys_gaz2975_ags"].Seats[0].ArcadeMode.Hatches