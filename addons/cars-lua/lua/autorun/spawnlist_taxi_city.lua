local V = {
	Name = "Taxi (Urban)",
	Model = "models/left4dead/vehicles/taxi_city.mdl",
	...
	Members = {
		...
		Gears = {-0.25,0,0.095,0.15,0.23,0.37,0.65}
	}
}
list.Set( "simfphys_vehicles", "sim_fphys_l4d_taxi_city", V )
...
list.Set( "simfphys_lights", "taxi_city", light_table)