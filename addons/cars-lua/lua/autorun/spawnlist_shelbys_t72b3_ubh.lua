...
sound.Add({
	name = "SHELBY_NSV_LOOP",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 130,
	sound = "^t72b3/nsv_loop.wav"
})

sound.Add({
	name = "SHELBY_NSV_LOOP_INSIDE",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 130,
	sound = "^t72b3/nsv_idl.wav"
})

sound.Add({
	name = "SHELBY_MG_NSV_LASTSHOT_01",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 130,
	sound = "^t72b3/nsv_tail.wav"
})

sound.Add({
	name = "SHELBY_MG_NSV_LASTSHOT_INSIDE_01",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 130,
	sound = "^t72b3/nsv_idt.wav"
})
...
list.Set("simfphys_vehicles","gred_simfphys_t72b3_ubh_custom",{
	Name = "T-72B3 UBH", 
	Model = Model("models/vehicles_merydian/tanks/t72b3/t72b3_ubh.mdl"),
	...
	Members = {
		...
		CustomMassCenter = Vector(-8.59375,0,45.4375),
		...
		FuelFillPos = Vector( -89.66, -43.44, 60.9 ),
		...
		Gears = {-0.02,0,0.04,0.06,0.08,0.1,0.15,0.2,0.24}
	}
})
...
gred.simfphys["gred_simfphys_t72b3_ubh_custom"] = {
	Seats = {
		[0] = { -- Driver
			ArcadeMode = {
				PlayerBoneManipulation = {
					["ValveBiped.Bip01_R_Thigh"] = Angle(-80,-90),
					["ValveBiped.Bip01_L_Thigh"] = Angle(80,-90),
				},
				...
				Secondary = {
					...
					Sounds = {
						...
						Stop = {
							"SHELBY_DSHK_LASTSHOT",
						},
						StopInside = {
							"GRED_MG_12MM_LASTSHOT_INSIDE_01",
							"GRED_MG_12MM_LASTSHOT_INSIDE_02",
							"GRED_MG_12MM_LASTSHOT_INSIDE_03",
						},
					},
					Spread = 0.15,
					ReloadTime = 5,
			...
			if tr.LocalHitPos.z > 67 then
				...
				if tr.PitchSideDetection == GRED_TANK_TOP then
					...
					if tr.YawSideDetection == GRED_TANK_FRONT then
						...
						if absy > 11 then
							if absy > 38 then
								tr.ArmourThicknessKE = 537
								tr.ArmourThicknessCHEMICAL = 561
							else
								tr.ArmourThicknessKE = 537
								tr.ArmourThicknessCHEMICAL = 561
							end
						else
							tr.ArmourThicknessKE = 288
							tr.ArmourThicknessCHEMICAL = 330
						end
					elseif tr.YawSideDetection == GRED_TANK_REAR then
						tr.ArmourThicknessKE = 150
					else
						tr.ArmourThicknessKE = 537
						tr.ArmourThicknessCHEMICAL = 561
					end
				...
				if tr.PitchSideDetection == GRED_TANK_TOP then
					if tr.LocalHitPos.x > 44 then
						tr.ArmourThicknessKE = 486
						tr.ArmourThicknessCHEMICAL = 642
					else
						tr.ArmourThicknessKE = 120
					end
				elseif tr.PitchSideDetection == GRED_TANK_BOTTOM then
					...
					elseif tr.YawSideDetection == GRED_TANK_REAR then
						...
						tr.ArmourThicknessKE = 152
						tr.ArmourThicknessCHEMICAL = 325
					end
				end
			end
...
gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[1].NormalMode = table.FullCopy(gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[0].ArcadeMode) -- we use table.FullCopy so we can change stuff
gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[1].NormalMode.Hatches = gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[1].ArcadeMode.Hatches -- we want the seat's normal mode to have the same hatches as in arcade mode
gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[1].NormalMode.FirstPersonViewPosIsInside = true
gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[1].NormalMode.ViewAttachment = nil
gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[1].NormalMode.ThirdPersonViewPos = Vector(20,70,80)
gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[1].NormalMode.Attachment = "turret_att"

gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[2].ArcadeMode = {
	FirstPersonViewPosIsInside = true,
	Attachment = "turret_att",
...
gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[2].NormalMode = gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[2].ArcadeMode

gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[0].NormalMode.Hatches = gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[0].ArcadeMode.Hatches
gred.simfphys["gred_simfphys_t72b3_ubh_custom"].Seats[0].NormalMode.ViewPort = {
	FreeView = true,
	--Attachment = "gunner_sight",
	Pos = Vector(80,0,60),
	Ang = Angle(0,0,0),
