local V = {
	Name = "'78 Pickup (Repaired)",
	Model = "models/left4dead/vehicles/pickup_truck_78.mdl",
	...
	Members = {
		...
		LPMountFront = Vector(114.8,0,29.8),
		LPMountRear = Vector(-115.2,0,29.8),
		LPGroup = Plates_L4D,
...
list.Set( "simfphys_vehicles", "sim_fphys_l4d_pickup_78", V )
...
local light_table = {
	...
	Headlamp_sprites = {
		...
		{pos = Vector(-17.6,-25,97.3),size = 50,color = Color(255,255,255,255),material = "l4d/corona"},
		{pos = Vector(-17.6,-25,97.3),size = 150,material = "l4d/corona"},
		{pos = Vector(-17.6,11.4,97.3),size = 50,color = Color(255,255,255,255),material = "l4d/corona"},
		{pos = Vector(-17.6,11.4,97.3),size = 150,material = "l4d/corona"},
...
list.Set( "simfphys_lights", "pickup78", light_table)