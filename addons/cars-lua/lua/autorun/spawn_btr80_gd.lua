...
sound.Add({
	name = "KPVT_LOOP_INSIDE",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 130,
	sound = "^btr80/loop_kpvt_far.wav"
})
...
list.Set("simfphys_lights","btr80",{
	ModernLights = false,
...
list.Set("simfphys_vehicles","gred_simfphys_btr80",{
	Name = "BTR-80", 
	Model = Model("models/btr/rus/btr80/btr80.mdl"),
...
gred.simfphys["gred_simfphys_btr80"] = {
	Seats = {
		[0] = { -- Driver
			ArcadeMode = {
...
gred.simfphys["gred_simfphys_btr80"].Seats[2].NormalMode = gred.simfphys["gred_simfphys_btr80"].Seats[2].ArcadeMode
gred.simfphys["gred_simfphys_btr80"].Seats[3].NormalMode = gred.simfphys["gred_simfphys_btr80"].Seats[3].ArcadeMode
gred.simfphys["gred_simfphys_btr80"].Seats[4].NormalMode = gred.simfphys["gred_simfphys_btr80"].Seats[4].ArcadeMode
gred.simfphys["gred_simfphys_btr80"].Seats[5].NormalMode = gred.simfphys["gred_simfphys_btr80"].Seats[5].ArcadeMode
gred.simfphys["gred_simfphys_btr80"].Seats[6].NormalMode = gred.simfphys["gred_simfphys_btr80"].Seats[6].ArcadeMode
gred.simfphys["gred_simfphys_btr80"].Seats[7].NormalMode = gred.simfphys["gred_simfphys_btr80"].Seats[7].ArcadeMode
gred.simfphys["gred_simfphys_btr80"].Seats[8].NormalMode = gred.simfphys["gred_simfphys_btr80"].Seats[8].ArcadeMode
gred.simfphys["gred_simfphys_btr80"].Seats[9].NormalMode = gred.simfphys["gred_simfphys_btr80"].Seats[9].ArcadeMode

gred.simfphys["gred_simfphys_btr80"].Seats[1].NormalMode = table.FullCopy(gred.simfphys["gred_simfphys_btr80"].Seats[0].ArcadeMode) -- we use table.FullCopy so we can change stuff
gred.simfphys["gred_simfphys_btr80"].Seats[1].NormalMode.Hatches = gred.simfphys["gred_simfphys_btr80"].Seats[1].ArcadeMode.Hatches -- we want the body_att's normal mode to have the same hatches as in arcade mode
gred.simfphys["gred_simfphys_btr80"].Seats[1].NormalMode.FirstPersonViewPosIsInside = true
gred.simfphys["gred_simfphys_btr80"].Seats[1].NormalMode.ViewAttachment = nil
gred.simfphys["gred_simfphys_btr80"].Seats[1].NormalMode.ThirdPersonViewPos = Vector(-17.3077,-21.5318,80)
gred.simfphys["gred_simfphys_btr80"].Seats[1].NormalMode.Attachment = "body_att"

gred.simfphys["gred_simfphys_btr80"].Seats[0].NormalMode.Hatches = gred.simfphys["gred_simfphys_btr80"].Seats[0].ArcadeMode.Hatches

gred.simfphys["gred_simfphys_btr80"].Seats[0].NormalMode.ViewPort = {
	FreeView = true,
