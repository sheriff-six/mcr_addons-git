local V = {
	Name = "Taxi (Rural)",
	Model = "models/left4dead/vehicles/taxi_rural.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_l4d_taxi_rural", V )
...
list.Set( "simfphys_lights", "taxi_rural", light_table)