local function mg_fire(ply,vehicle,shootOrigin,shootDirection)
	...
	vehicle:EmitSound("ural4320zu_fire")
...
function simfphys.weapon:Initialize( vehicle )
	net.Start( "ural4320zu_register_tank")
		net.WriteEntity( vehicle )
		net.WriteString( "ural4320zu" )
	net.Broadcast()
	...
	simfphys.RegisterCamera( vehicle.pSeat[1], Vector(-25.5,-30.0,-0.5), Vector(-25,0,100), true,"mashingun_cannon_pitch" )
