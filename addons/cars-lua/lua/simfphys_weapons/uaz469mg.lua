local function mg_fire(ply,vehicle,shootOrigin,shootDirection)
	...
	vehicle:EmitSound("uaz469mg_fire")
...
function simfphys.weapon:Initialize( vehicle )
	net.Start( "uaz469mg_register_tank")
		net.WriteEntity( vehicle )
		net.WriteString( "uaz469mg" )
	net.Broadcast()
	...
	simfphys.RegisterCamera( vehicle.pSeat[1], Vector(-30.5,-8.8,0.25), Vector(0,0,50), true,"mashingun_cannon_pitch" )
...
function simfphys.weapon:Attack( vehicle, ply, shootOrigin, Attachment, ID )
	...
	if reloudsA<50 then
		...
		vehicle:EmitSound("weapons/reload/cwDSHK_reload.wav")
		reloudsA=0
