...
ENT.PrintName		        =  "[ROCKETS]9M133 Rocket"
ENT.Author			        =  ""
ENT.Contact			        =  ""
ENT.Category                =  "Gredwitch's Stuff"

ENT.Model                	=  "models/vehicles_shelby/rockets/atgm/9m133.mdl"
			...
			if self.LaserGuided == true then
				if IsValid(self.Launcher) then
					...
					if Parent:GetAttachment( ID ) then
						...
						phys:SetVelocity( self:GetVelocity() + self:GetAngles():Forward() * 10 )      
					end
				else
