...
ENT.PrintName		        =  "[ROCKETS]9M311 Rocket"
ENT.Author			        =  ""
ENT.Contact			        =  ""
ENT.Category                =  "Gredwitch's Stuff"

ENT.Model                	=  "models/vehicles_shelby/tanks/2s6_tunguska/9m311_rocket.mdl"
...
ENT.StartSound              =  "TUNGUSKA_ROCKET_CANNON_FIRE"
ENT.ArmSound                =  ""
ENT.ActivationSound         =  ""
...
ENT.TNTEquivalent			=	4.62
ENT.FuelBurnoutTime			=	100
ENT.LinearPenetration		=	39
ENT.MaxVelocity				=	910
ENT.Caliber					=	76
			...
			if self.LaserGuided == true then
				if IsValid(self.Launcher) then
					...
					if Parent:GetAttachment( ID ) then
						...
						phys:SetVelocity( self:GetVelocity() + self:GetAngles():Forward() * 3 )      
					end
				else
