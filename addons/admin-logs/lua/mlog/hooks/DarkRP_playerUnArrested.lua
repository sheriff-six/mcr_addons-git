...
hook.Add("playerUnArrested", HOOK.hook_name .. "un", function(ply, unarrester)
	...
	if IsValid(unarrester) then
		mLog.Log("playerArrested", unarrest .. " unarrested " .. victim)
	else
		mLog.Log("playerArrested", victim .. " was unarrested")
	end
end)