...
concommand.Add("cl_nt_open",function()
 ...
 local ButtonNextPage = vgui.Create("DButton",Frame)
  ButtonNextPage:SetPos(310,25)
  ButtonNextPage:SetSize(40,25)
  ButtonNextPage:SetText(Langlue and Langlue.NextPage or ":MISSING:")
 ...
 local ButtonDownPage = vgui.Create("DButton",Frame)
  ButtonDownPage:SetPos(350,25)
  ButtonDownPage:SetSize(40,25)
  ButtonDownPage:SetText(Langlue and Langlue.BackPage or ":MISSING:")
 ...
 local ButtonBaked = vgui.Create("DButton",Frame)
  ButtonBaked:SetPos(245,25)
  ButtonBaked:SetSize(65,25)
 ...
 local ButtonPaint = vgui.Create("DButton",Frame)
  ButtonPaint:SetPos(180,25)
  ButtonPaint:SetSize(65,25)
